...
@section('title', 'Livres — Développement Logiciel')
@section('content')
...
<div class="mb-6 flex items-start justify-between gap-4 flex-wrap">
    <div>
        <div class="flex items-center gap-3 mb-1">
            <div class="w-8 h-8 rounded-lg flex" style="background:rgba(46,158,107,0.1); items-center justify-center">
                <i class="fas fa-laptop-code text-sm" style="color:#2E9E6B;"></i>
            </div>
            <h2 class="text-2xl font-bold text-slate-800">Livres — Développement Logiciel</h2>
        </div>
        <p class="text-sm text-slate-500 ml-11">Design patterns, agile, testing and architecture</p>
    </div>
    <span class="inline-flex items-center gap-2 text-xs font-bold px-3" style="background:#D1FAE5;color:#065F46; py-1.5 rounded-full " style="background:#D1FAE5;color:#065F46;border:1px solid rgba(46,158,107,0.25);">
        ...
        <table id="dataTable" class="w-full text-sm">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-100">
                    ...
                    <th class="text-left px-5 py-3.5 text-xs font-bold uppercase tracking-wider">Emprunté</th>
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-5 py-3.5">
                        @if($available > 0)
                            <span class="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full" style="background:#D1FAE5;color:#065F46;">
                                <span class="w-1.5 h-1.5 rounded-full rounded-full" style="background:#2E9E6B;"></span> {{ $available }} disponible
                            </span>
                        @else
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex items-center gap-1.5 text-slate-500 text-xs">
                            <i class="fas fa-map-pin text-[10px]" style="color:#2E9E6B;"></i>
                ...
                <tr>
                    <td colspan="9" class="px-6 py-20 text-center">
                        <div class="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4" style="background:rgba(46,158,107,0.09);">
                            <i class="fas fa-laptop-code text-4xl" style="color:rgba(46,158,107,0.3);"></i>
                        </div>
                        <p class="text-slate-500 font-semibold">No Livres — Développement Logiciel yet</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
