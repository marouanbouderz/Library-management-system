    ...
    <div>
        <div class="flex items-center gap-3 mb-1">
            <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center">
                <i class="fas fa-network-wired text-sky-600 text-sm"></i>
            </div>
            <h2 class="text-2xl font-bold text-slate-800">Livres — Réseaux</h2>
        </div>
        <p class="text-sm text-slate-500 ml-11">TCP/IP, routing, security and network protocols</p>
    </div>
    <span class="inline-flex items-center gap-2 bg-sky-50 text-sky-700 text-xs font-bold px-3 py-1.5 rounded-full border border-sky-200">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-sky-50/40 transition-colors">
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex items-center gap-1.5 text-slate-500 text-xs">
                            <i class="fas fa-map-pin text-sky-300 text-[10px]"></i>
                ...
                <tr>
                    <td colspan="9" class="px-6 py-20 text-center">
                        <div class="w-20 h-20 bg-sky-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <i class="fas fa-network-wired text-sky-200 text-4xl"></i>
                        </div>
                        <p class="text-slate-500 font-semibold">No Livres — Réseaux yet</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
