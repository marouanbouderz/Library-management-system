    ...
    <div>
        <div class="flex items-center gap-3 mb-1">
            <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:rgba(8,145,178,0.1);">
                <i class="fas fa-drafting-compass text-sm" style="color:#0891b2;"></i>
            </div>
            <h2 class="text-2xl font-bold text-slate-800">Livres — Génie Civil</h2>
        </div>
        <p class="text-sm text-slate-500 ml-11">Structures, béton, topographie et travaux publics</p>
    </div>
    <span class="inline-flex items-center gap-2 text-xs font-bold px-3 py-1.5 rounded-full"
          style="background:#CFFAFE; color:#0e7490; border:1px solid rgba(8,145,178,0.25);">
        ...
        <table id="dataTable" class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-5 py-3.5">
                        @if($available > 0)
                            <span class="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full" style="background:#CFFAFE; color:#0e7490;">
                                <span class="w-1.5 h-1.5 rounded-full" style="background:#0891b2;"></span> {{ $available }} disponible
                            </span>
                        @else
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex items-center gap-1.5 text-slate-500 text-xs">
                            <i class="fas fa-map-pin text-[10px]" style="color:#0891b2;"></i>
                ...
                <tr>
                    <td colspan="9" class="px-6 py-20 text-center">
                        <div class="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4" style="background:rgba(8,145,178,0.09);">
                            <i class="fas fa-drafting-compass text-4xl" style="color:rgba(8,145,178,0.3);"></i>
                        </div>
                        <p class="text-slate-500 font-semibold">Aucun livre Génie Civil disponible</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
