...
<div class="flex items-center justify-between mb-6">
    <div>
        <h2 class="text-xl font-bold text-slate-800">Livres — Programmation</h2>
        <p class="text-sm text-slate-500 mt-0.5">Browse the programming category collection</p>
    </div>
    <div class="flex items-center gap-3">
        <nav class="flex items-center gap-2 text-xs text-slate-400">
            <a href="{{ url('admin/dashboard') }}" class="hover:text-[#4F6FCD] transition-colors">Dashboard</a>
            <i class="fas fa-chevron-right text-[10px]"></i>
            <span class="text-slate-600 font-medium">Livres — Programmation</span>
        </nav>
...
<div class="bg-white rounded-2xl shadow-md overflow-hidden">
    <div class="px-6 py-4 flex items-center gap-3" style="border-bottom:1px solid #E8EDF2;">
        <div class="w-9 h-9 rounded-xl flex items-center justify-center" style="background:rgba(79,111,205,0.09);">
            <i class="fas fa-code" style="color:#4F6FCD;"></i>
        </div>
        <div>
            <h3 class="font-bold text-slate-800 text-sm">Programming Collection</h3>
            <p class="text-xs text-slate-400">All programming & computer science books</p>
        </div>
    </div>
                ...
                <tr>
                    <td colspan="7" class="px-6 py-20 text-center">
                        <div class="flex flex-col items-center gap-4">
                            ...
                            <p class="font-bold text-slate-500">No Livres — Programmation found</p>
